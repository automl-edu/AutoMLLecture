...
Introduced by \lit{Zoph et al.’18}
\end{frame}
%----------------------------------------------------------------------
%----------------------------------------------------------------------
...
\begin{itemize}
	...
	\item[--] Each node a lattent representation; each edge an operation/motif
...
{\centering
	\includegraphics[width=\textwidth]{images_lec7/s27}
}
\end{frame}
%----------------------------------------------------------------------
%----------------------------------------------------------------------
...
\centering
\begin{itemize}
	\item Standard evlutionary algorithm, but oldest solutions are dropped from
	population P, instead of the worst.
	\item Same cell search space as in \lit{Zoph et al ’18}\\
\end{itemize}
