...
\centering
	\begin{itemize}
		...
		\begin{itemize}
			\begin{footnotesize}
			\item Weight sharing \lit{Pham et al,’18; Bender et al, ’18; Liu et al, ‘18; Xie et al. ’19; Cai et al. ’19}
...
%-----------------------------------------------------------------------
\begin{frame}[c]{Reinforcement Learning \litw{Zoph \& Le, ICLR 2016}}
\centering
\begin{itemize}
...
\begin{frame}[c]{Learning CNN cells with RL \litw{Zoph \& Le, ’16; Zoph et al. ’17}}
\centering
...
\begin{frame}[c]{Reinforcement Learning \litw{Zoph \& Le, ’16; Zoph et al. ’17}}
\begin{itemize}
...
%----------------------------------------------------------------------
%----------------------------------------------------------------------
\begin{frame}[c]{DARTS: Differentiable Architecture Search \litw{Liu et al. ’18}}
