...
\begin{itemize}
	...
	\end{itemize}
	\pause
	\item Trade-off: Find a way from $\conf_{\text{start}}$ to $\conf_{\text{end}}$ in a greedy fashion \litw{\href{https://link.springer.com/article/10.1007\%2Fs10732-014-9275-9}{Fawcett and Hoos 2016}}
\end{itemize}
