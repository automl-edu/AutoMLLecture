...
\footnotesize
	...
	\node[input neuron, pin=left:$\feat(\inst_i)_1$] (I-1) at (0,-1.8) {};
	\node[input neuron, pin=left:\ldots] (I-2) at (0,-2.6) {};
	\node[input neuron, pin=left:$\feat(\inst_i)_m$] (I-3) at (0,-3.4) {};
    ...
    \node[output neuron,pin={[pin edge={->}]right:$\theta^{\inst_i}_1$}, right of=H2-2] (O-1) {};
    \node[output neuron, pin={[pin edge={->}]right:\ldots}, right of=H2-3] (O-2) {};
    \node[output neuron,pin={[pin edge={->}]right:$\theta^{\inst_i}_p$}, right of=H2-4] (O-3) {};
