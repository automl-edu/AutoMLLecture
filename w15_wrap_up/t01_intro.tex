    ...
    \begin{columns}
      \begin{column}{0.4\textwidth}
        ...
        \begin{itemize}
          ...
          \end{itemize}
          \item Happens indirectly in learning algorithm: decision tree, lasso regression, \ldots %FIXME More examples.
        \end{itemize}
      \end{column}%
      \begin{column}{0.6\textwidth}
        \begin{center}
...
\begin{frame}{Imbalanced Classes}
  ...
  \begin{itemize}
    ...
    \item Intelligent over-sampling strategies (e.g.\ SMOTE) can lead to improvement in predictive accuracy
  \end{itemize}
\end{frame}
...
\begin{frame}{Practical Problems: Parallelization}
  ...
  Possible problems:
  \begin{itemize}
    \item Sequential nature of HPO algorithms (e.g.\ Bayesian optimization)
