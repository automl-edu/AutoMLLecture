...
\begin{frame}{Choice of Learning Algorithm}
  \begin{itemize}
    ...
    \item A plethora of learners exists, for different data sets different models
        are likely needed.
    \item Studies~\lit{\href{https://dl.acm.org/doi/10.5555/2627435.2697065}{Delgado et al., JMLR 2014}} and experience show:\\
  ...
  \end{itemize}
      ...
      \item Example: Auto-Sklearn 2.0~\lit{\href{https://arxiv.org/abs/2007.04074}{Feurer et al., 2020}} uses: 
    \begin{itemize}
        \item extra trees 
         \item gradient boosting 
  ...
  \begin{columns}
    ...
    \begin{column}{0.4\textwidth}
      \begin{center}
        ...
        {\tiny Taken from \lit{\href{https://www.jmlr.org/papers/volume20/18-444/18-444.pdf}{Probst et al., 2019 JMLR}}.}
      \end{center}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Preprocessing capabilities differ heavily}
  \begin{columns}
    ...
    \begin{column}{0.4\textwidth}
    \small
      Taken from~\lit{\href{https://doi.org/10.1109/ICTAI.2019.00209}{Truong et al., 2019 ICTAI}}.
      \vspace{1em}
    ...
    \begin{columns}
      ...
      \begin{column}{0.6\textwidth}
        \begin{center}
          ...
          {\tiny \hfill Taken from \lit{\href{https://doi.org/10.1145/3377930.3389815}{Binder et al., 2020 GECCO}}.}
        \end{center}
      \end{column}
    \end{columns}
...
\begin{frame}{Obtaining Final Model}
  ...
  \begin{itemize}
    ...
    \item Build ensemble of best configurations\\ 
        (e.g. \lit{\href{https://papers.nips.cc/paper/2015/hash/11d0e6287202fced83f79975ec59a3a6-Abstract.html}{Feurer et al., NIPS 2015}}, \lit{\href{https://www.automl.org/wp-content/uploads/2020/07/AutoML_2020_paper_61.pdf}{H2O AutoML, LeDell et al., 2020}}).
  \end{itemize}
  \begin{center}
