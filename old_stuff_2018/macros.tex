...
% \newcommand{\insts}[0]{I}
% \newcommand{\inst}[0]{i}
% \newcommand{\pcs}[0]{\vec{C}}
% \newcommand{\conf}[0]{\vec{c}}

%Franks Notation
\newcommand{\norm}{{\mathcal{N}}}
\newcommand{\cutoff}[0]{\kappa}
\newcommand{\instD}[0]{\mathcal{D}}
\newcommand{\insts}[0]{\Pi}
\newcommand{\inst}[0]{\pi}
\newcommand{\pcs}[0]{\mathbf{\Theta}}
\newcommand{\bx}[0]{\conf}
\newcommand{\conf}[0]{\mathbf{\theta}}
...
\newcommand{\surro}[0]{\hat{c}}
\newcommand{\epm}[0]{\surro}
\newcommand{\portfolio}[0]{\mathcal{P}}
\newcommand{\schedule}[0]{\mathcal{S}}
\newcommand{\policies}[0]{\Omega}
\newcommand{\policy}[0]{\omega}
\newcommand{\state}[0]{s}
\newcommand{\states}[0]{\mathcal{S}}
