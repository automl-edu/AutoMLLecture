...
\begin{document}
	...
	\begin{questions}
		...
		We provide you with the objective function to be optimized. You will implement the DE to \textbf{minimize} this function.
		\begin{parts}
		...
		\part[1.5] Generate plots that demonstrate the functionality of DE algorithm, e.g. best-so-far seen function value over time. Compare your results of DE against BO, Random Search and Gird Search for at most 200 function evaluations. Add all plots to a PDF and briefly discuss what you can learn from these plots, and add some observations about computational time for DE versus other compared optimizers.\footnote{Hint: Your implementation of DE should perform 20 generations .} 
	\end{parts}
