...
\begin{document}
	...
	\begin{questions}
		...
		\begin{parts}
			...
			\part[1] Implement a paired permutation test. Using $H_0=$ $A$ and $B$ have equal menas, what are the test statistics with $10000$ repetitions? Would you reject $H_0$ with $\alpha=0.01$?
		\end{parts}
