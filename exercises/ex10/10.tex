...
\newcommand{\duedate}{12.06.19 (10:00)}
...
\begin{document}
	...
	\begin{questions}
		...
		\part[3] In the same folder you called \texttt{main.py} from, the results of training will be stored. Plot the true reward against the expected reward for all
