...
\centering
	...
	\end{itemize}
	\includegraphics[width=0.6\textwidth]{images/NAS-RL-space_as_HPO}
	
}
%----------------------------------------------------------------------

%----------------------------------------------------------------------
\myframetop{Example of an architecture sample}{
\centering
\begin{columns}
	\column{0.3\textwidth}
	\centering
...
\centering
What are some pros and cons of the cell search space compared to the chain-structured one?\\~\\
...
\myframe{Questions to Answer for Yourself / Discuss with Friends}{
	...
	\myit{
		\item Repetition:\\ \alert{What are some pros and cons of the cell search space compared to the chain-structured one?
}
\medskip
		\item Discussion:\\ \alert{What are some pros and cons of the hierarchical search space compared to the other ones?}
	}	 
}
%-----------------------------------------------------------------------
