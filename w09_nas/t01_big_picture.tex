\renewcommand{\lecturetitle}{Motivation and Brief History}
...
%----------------------------------------------------------------------
\myframetop{Successful Human-designed Architectures}{
...
%\medskip
		\item Repetition:\\ \alert{How are the weight optimized in neuroevolution?}
