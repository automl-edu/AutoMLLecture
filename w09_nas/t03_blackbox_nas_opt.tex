...
\myframe{Early Work on Neuroevolution (already since the 1990s)\\ \litw{\href{https://www.complex-systems.com/abstracts/v04_i04_a06/}{Kitano 1990}; \href{http://www.demo.cs.brandeis.edu/papers/ieeenn.pdf}{Angeline et al. 1994}; \href{http://nn.cs.utexas.edu/downloads/papers/stanley.ec02.pdf}{Stanley and Miikkulainen, 2002}; 
...
\medskip
		...
		\myit{
			...
			\item SMAC \lit{\href{https://ml.informatik.uni-freiburg.de/papers/15-IJCAI-Extrapolation_of_Learning_Curves.pdf}{Domhan et al. 2015}, \href{https://ml.informatik.uni-freiburg.de/papers/16-AUTOML-AutoNet.pdf}{Mendoza et al. 2016}, \href{https://arxiv.org/abs/1807.06906}{Zela et al. 2018}}
		}
	}
