...
\begin{figure}
    \centering
    \only <1>{\includegraphics[width=0.5\textwidth]{w07_hpo_grey_box/images/learningcurve/learning_curve_questionmark.png}}
    \only <2->{\includegraphics[width=0.5\textwidth]{w07_hpo_grey_box/images/learningcurve/learning_curve_single_pred.jpg}}
...
\centering
\includegraphics[width=0.8\textwidth]{images/learningcurve/learning_curve_dec.png}
...
\centering
\includegraphics[width=0.8\textwidth]{images/learningcurve/learning_curve_dec2.png}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{images/learningcurve/Domhan_types_of_curves.png}\\
...
{
\begin{center}
\includegraphics[width=0.9\textwidth]{images/learningcurve/learning_curve_tuning.jpg}
...
{
\begin{center}
\includegraphics[width=0.5\textwidth]{images/learningcurve/learning_curve_tuning.jpg}
...
\begin{center}
	\includegraphics[width=0.58\textwidth]{images/learningcurve/Gargiani-MNIST-extrapolations_1.png}\\
	\includegraphics[width=0.58\textwidth]{images/learningcurve/Gargiani-MNIST-extrapolations_2.png}\\
\end{center}	
...
\begin{center}
	\includegraphics[width=0.9\textwidth]{images/learningcurve/Gargiani-MNIST-extrapolation-quality-based-on-different-sized-prefixes.png}
\end{center}	
\end{frame}
%-----------------------------------------------------------------------
%-----------------------------------------------------------------------
