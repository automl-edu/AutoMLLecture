...
\begin{figure}
    \centering
    \vspace{2em}
    \only<3>{\includegraphics[width=\linewidth]{w07_hpo_grey_box/images/hyperband/SH-1.png}}
    \only<4>{\includegraphics[width=\linewidth]{w07_hpo_grey_box/images/hyperband/SH-2.png}}
    \only<5>{\includegraphics[width=\linewidth]{w07_hpo_grey_box/images/hyperband/SH-3.png}}
    \only<6>{\includegraphics[width=\linewidth]{w07_hpo_grey_box/images/hyperband/SH-4.png}}
