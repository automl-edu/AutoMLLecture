...
\begin{column}{.48\textwidth}
    ...
    \centering
    \only<1-2>{\includegraphics[width=.8\textwidth]{images/meta_learning/task_independent.jpg}}
    \only<3-7>{\includegraphics[width=.9\textwidth]{images/meta_learning/task_independent_results.jpg}}
