...
\begin{itemize}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{w07_hpo_grey_box/images/success_stories/FB_RGPE.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{w07_hpo_grey_box/images/success_stories/RQ1_60MIN_ens_rank.pdf}
    \includegraphics[width=\textwidth]{w07_hpo_grey_box/images/success_stories/RQ1_legend.pdf}
    \label{fig:my_label}
\end{figure}
\end{columns}
