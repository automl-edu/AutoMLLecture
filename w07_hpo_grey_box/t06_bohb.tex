...
\begin{figure}
    \centering
    \includegraphics[width=0.70\textwidth]{w07_hpo_grey_box/images/bohb/cartpole-1.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.70\textwidth]{w07_hpo_grey_box/images/bohb/svm_surrogate_test.pdf-1.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.70\textwidth]{w07_hpo_grey_box/images/bohb/countingones_bohb.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.70\textwidth]{w07_hpo_grey_box/images/bohb/surrogate_on_poker.png}
