...
\begin{frame}[allowframebreaks]{S-Metric Selection-based EGO}
    ...
    \textbf{Problem}: Based on the way the hypervolume contribution is measured large plateaus of zero improved are present.
    \begin{itemize}
    ...
    \vspace{0.5cm}
        ...
        This method is referred to as SMS-EGO~\litw{\href{https://doi.org/10.1007/978-3-540-87700-4_78}{Ponweiser et al. 2008}}.
\end{frame}
