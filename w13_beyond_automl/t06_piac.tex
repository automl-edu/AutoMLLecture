...
%----------------------------------------------------------------------
%----------------------------------------------------------------------
\begin{frame}{Instance-Specific Algorithm Configuration: ISAC{} \litw{\href{http://ebooks.iospress.nl/publication/5873}{Kadioglu et al. 2010}}}
...
%----------------------------------------------------------------------
%----------------------------------------------------------------------
\begin{frame}[c]{Hydra~\litw{\href{https://www.aaai.org/ocs/index.php/AAAI/AAAI10/paper/view/1929}{Lin et al. 2010}}}
...
%----------------------------------------------------------------------
%----------------------------------------------------------------------
\begin{frame}[c]{Cedalion~\litw{\href{https://www.aaai.org/ocs/index.php/AAAI/AAAI15/paper/view/10021}{ Seipp et al 2015}}}
...
At most away from optimum by factor of $0.63$ (see \lit{\href{http://papers.nips.cc/paper/3569-an-online-algorithm-for-maximizing-submodular-functions}{Streeter \& Golovin '08}})
\end{block}

\end{frame}
%----------------------------------------------------------------------
%----------------------------------------------------------------------
\begin{frame}[c]{Dynamic Instance Grouping \litw{\href{https://aaai.org/ojs/index.php/AAAI/article/view/3970}{Liu et al. 2019}}}
