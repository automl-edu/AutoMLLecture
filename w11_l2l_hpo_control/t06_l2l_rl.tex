...
\begin{itemize}
\item Since the RL agent will optimize the cumulative cost, this is equivalent to $\loss_{\text{sum}}$ \lit{Chen et al. 2017} ($\gamma=0$)
...
\begin{itemize}
\item Approach by \lit{Volpp et al. 2019} called MetaBO
