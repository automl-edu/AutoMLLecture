...
%----------------------------------------------------------------------
%----------------------------------------------------------------------
\begin{frame}[c]{Learning to Optimize via Reinforcement Learning \lit{Li and Malik'17}}
...
%----------------------------------------------------------------------
%----------------------------------------------------------------------
\begin{frame}[c]{Learning to Optimize via Reinforcement Learning Results \lit{Li and Malik'17}}
...
\end{itemize}
\pause
\item[State $\stateRL_t$:] $\mu_t$ and $\sigma_t$ on a set of points $\xi_t$
\pause
\item[Action $\actionRL_t$:] Sampled point $x_t$
\pause
...
\centering
\includegraphics[width=0.8\textwidth]{images/l2acq_results.png}
