...
%----------------------------------------------------------------------
%----------------------------------------------------------------------
\begin{frame}[c]{Population-based Training \lit{\href{https://arxiv.org/abs/1711.09846}{Jaderberg et al. 2017}}}
...
%----------------------------------------------------------------------
%----------------------------------------------------------------------
\begin{frame}[c]{Population-based Training \lit{\href{https://arxiv.org/abs/1711.09846}{Jaderberg et al. 2017}, \href{https://arxiv.org/abs/2002.04225}{Liang et al. 2020}}}
...
\begin{enumerate}
	...
	\begin{itemize}
		\item Changes the hyperparameter settings, but inherits the partially trained model
	\end{itemize}
	\pause
	\item[$\leadsto$] New population consisting so-far best performing ones and new off-springs
	\pause
	\item Go to 2.
\end{enumerate}
