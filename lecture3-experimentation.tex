...
%----------------------------------------------------------------------
%----------------------------------------------------------------------
\begin{frame}[c]{Compare Learning Curves}
...
\begin{itemize}
	...
	\item generalization nevertheless not perfect
\end{itemize}
...
\centering
\includegraphics[width=0.7\textwidth]{scripts/mlp12_test_ecdf.jpg}
...
\centering
\includegraphics[width=0.7\textwidth]{scripts/mlp12_boxplot.jpg}
...
\begin{itemize}
	...
	\pause
	\medskip
	\item Recommendation: plot performance (e.g., accuracy) over time
	\begin{itemize}
...
\centering
\includegraphics[width=0.6\textwidth]{images/MLPOnMnist_tFalse.png}

\begin{itemize}
	\item Different HPO systems minimizing the error of an MLP on MNIST
	\item How to do it:
	\begin{itemize}
		\item Run each systems several times and log its current incumbent always
		\item Plot mean and stdev for each system
...
\begin{itemize}
	...
	\item To summarize and compare the performnance accross a set of datasets,
	...
	\end{enumerate}
    \pause
    \item[$\leadsto$] There is no way around it that you have some kind of information loss 
\end{itemize}
...
\centering
\includegraphics[width=0.6\textwidth]{images/rankings_over_time.png}

\begin{itemize}
	\item Rankings avoid the problem of different scales
