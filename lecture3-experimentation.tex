...
\medskip
\pause
\item Beware (ii): if you use cross-validation, you cannot apply statistical tests because observations are not independent
\begin{itemize}
...
\begin{enumerate}
	...
	\item avoid peaking at your test data
	\begin{itemize}
